        ...
        <main className="flex w-screen	 flex-col items-center justify-between p-24">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div className="flex-1">
                    <div style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto', maxWidth: '100%', borderRadius: '10px', scrollbarWidth: 'none' }}>
                        <iframe
                            width="540"
                            height="550"
                        ...
                        <div className='content-center m-6'>
                            <p className='my-2'>QR Code for Site</p>
                            <Image
                                className="relative shadow dark:drop-shadow-[0_0_0.3rem_#ffffff70] dark:invert"
                                src="/ffgg_qr.svg"
                                alt="FFGG QR"
                                width={180}
                                height={37}
