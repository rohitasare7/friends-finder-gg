  ...
  return (
    ...
    <div className="flex w-full flex-col items-center justify-between p-4 md:p-24 backdrop-blur-2xl bg-white/30">
      ...
      <main className="flex-grow flex flex-col md:flex-row">
        ...
        <div className="p-4 md:w-1/2 md:ml-24">
          <div className="mt-4 p-6 bg-white border border-gray-200 rounded-lg shadow ">
            <a href="#">
              <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 ">13th Nov 2023</h5>
            </a>
            <p className="mb-2 font-normal text-gray-900 ">Please find below updates :</p>
            <ul className="w-full text-sm space-y-1 text-gray-800 list-disc list-inside">
              <li>
            ...
            <div className="p-4 mt-4 border text-sm text-blue-800 rounded-lg bg-blue-50" role="alert">
            ...
            <div className="p-4 mt-3 border text-sm text-green-800 rounded-lg bg-green-50 " role="alert">
            ...
            <div className="p-4 mt-3 border text-sm text-yellow-800 rounded-lg bg-yellow-50 " role="alert">
            ...
            <div className='mt-4'>
              <label className="block mb-3 text-sm font-medium text-gray-900 ">Shortened link for Sharing (Select and then Copy)</label>
              <input type="text" id="large-input" value={'https://bit.ly/ffgg'} className="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500 " />
            </div>
      ...
      <footer>
        ...
        <div className="text-center mt-10 p-6 bg-white border border-gray-200 rounded-lg shadow ">
          <div>
